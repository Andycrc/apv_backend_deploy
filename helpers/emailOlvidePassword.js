...
const emailOlvidePassword = async (datos) => {
    ...
    const info = await transporter.sendMail({
        ...
        to: email,
        subject: "Restablece tu contraseña en tu APV",
        text: "Restablece tu contraseña en tu APV",
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
            <h2 style="color: #333;">Hola ${nombre},</h2>
            <p style="color: #555;">Recibimos una solicitud para restablecer tu contraseña en APV. Para continuar, haz clic en el botón de abajo:</p>
